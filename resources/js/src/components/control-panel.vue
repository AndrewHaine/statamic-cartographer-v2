<template>
  <div>
    <div class="cartographer-field__controls flex justify-between items-center">
      <div class="cartograher-field__marker-controls flex items-center justify-center">
        ...
        <div v-if="!selectedMarker" class="my-1 mr-2">
          <a href="#" class="btn-flat px-3 py-1 bg-grey-30 text-sm flex items-center" @click.prevent="addMarker">
            Marker
            <i class="icon icon-plus icon-right"></i>
          </a>
        </div>
        <div v-if="selectedMarker" class="btn-group my-1 mr-2">
          <a href="#" class="btn btn-white mr-1 flex items-center" @click.prevent="toggleMarkerEditorOpen">
...
export default {
  ...
  components: {
    'cartographer-marker-editor': MarkerEditor
  },
