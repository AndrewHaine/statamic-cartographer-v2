Vue.component('cartographer-advanced-box', require('./components/advanced-box.vue'));
Vue.component('cartographer-control-panel', require('./components/control-panel.vue'));
Vue.component('cartographer-marker-editor', require('./components/marker-editor.vue'));
